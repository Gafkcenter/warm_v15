...
<body>
	<h1>
		<a href="${BASE}/admin/home">首页</a> / <a href="${BASE}/size/l">尺码管理</a> / 添加尺码
	</h1>
<div id="global">
<!-- 错误提示 -->
	...
	<form id="size_form">
		<table>
			...
			<tr>
				<td>服装型号：</td>
				<td>
				<select name="bodytype" id="bodytype" class="bodytype">
			...
			<tr>
				<td>鞋子尺码：</td>
				<td>
				<select name="shoessize" id="shoessize" class="shoessize">
		...
		<button type="submit">保存尺码</button>
	</form>
</div>
