package com.gafker.manage.mapper.base;
...
public interface GafkerMapper<T> {
     ...
     * @return
     */
    @DeleteProvider(type = GafkerMapperProvider.class, method = "dynamicSQL")
     ...
     * @return
     */
    @SelectProvider(type = GafkerMapperProvider.class, method = "dynamicSQL")
     ...
     * @return
     */
    @InsertProvider(type = GafkerMapperProvider.class, method = "dynamicSQL")
    int insert(T record);
     ...
     * @return
     */
    @UpdateProvider(type = GafkerMapperProvider.class, method = "dynamicSQL")
