...
public class HttpRequestHttpClientRequestFormFile {
	/**
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			HttpEntity reqEntity = MultipartEntityBuilder.create().addPart("media", bin)// 相当于<input
																						// type="file"
																						// name="media"/>
					.addPart("comment", comment).addPart("name", name)// 相当于<input
																		// type="text"
																		// name="name"
																		// value=name>
